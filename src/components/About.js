...
export default class About extends Component {
  componentDidMount() {
    ...
    console.log(`%c If you are curious about my code, feel free to check it out! Happy coding :)`, 'margin: 20px; text-align: center; padding: 5px 15px 20px 15px; font-size: 12px; color: papayawhip; text-shadow: 1px 1px 0 #138086 , 2px 2px 0 #534666 , 3px 3px 0 black');
